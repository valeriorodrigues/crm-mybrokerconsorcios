              ...
              <ContactDetail
                ...
                onCreateNegInline={(data) => {
                  const neg = {
                    ...
                    name: data.name,
                    stage: data.stage || "Novos Leads",
                    value: data.value || "",
                    status: "open",
                    createdAt: today(),
                  };
                  const act = {
                    id: uid(), contactId: selected.id, negotiationId: neg.id,
                    channel: "Sistema",
                    description: `📋 Negociação criada: ${neg.name} (${neg.product} · ${neg.stage})`,
                    date: today(),
                  };
                  setNegotiations(p => [...p, neg]);
                  setActivities(p => [...p, act]);
                  db.saveNegotiation(neg);
                  db.saveActivity(act);
                }}
