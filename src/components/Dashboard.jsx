...
import { AreaChart, Area, BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, CartesianGrid, Cell, LineChart, Line, PieChart, Pie } from "recharts";
        ...
        <div className="panel">
          ...
          <div className="panel-body" style={{ padding: "8px 0 0" }}>
            <ResponsiveContainer width="100%" height={180}>
              <BarChart data={salesChart} margin={{ top: 0, right: 10, bottom: 0, left: -20 }}>
