...
import { STAGES, PIPELINE_STAGES, STAGE_COLORS, PRODUCT_COLORS, GRADE_COLORS, CHANNELS } from "../utils/constants";
    ...
    <div className="fade-in">
      ...
      <div className="pipeline-bar">
        {PIPELINE_STAGES.map((stg, i) => {
          const active = stg === n.stage, passed = PIPELINE_STAGES.indexOf(n.stage) > i;
