...
import { RELATIONSHIPS, COMPANY_ROLES, STAGES, PIPELINE_STAGES, STAGE_COLORS, PRODUCT_COLORS, GRADE_COLORS, CHANNELS, FOLLOW_STATUSES, LEAD_ORIGIN_GROUPS, TAG_PALETTE } from "../utils/constants";
        ...
        <div>
          ...
          <Panel title={`Negociações (${negotiations.length})`}>
            ...
            {negotiations.map(n => {
              ...
              const prodColor = PRODUCT_COLORS[n.product] || "#888";
              const gradeColor = GRADE_COLORS[sc.grade] || "#888";
              return (
                <div key={n.id} onClick={() => setActiveNegId(n.id)} style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 5, marginBottom: 3 }}>
                    ...
                    <div className="grade" style={{ background: gradeColor + "22", color: gradeColor, width: 17, height: 17, fontSize: 8.5, marginLeft: "auto" }}>{sc.grade}</div>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 5, flexWrap: "wrap" }}>
                    <span className="tag" style={{ background: prodColor + "22", color: prodColor }}>{n.product}</span>
            ...
            <button className="btn btn-sm btn-primary" style={{ marginTop: 6, width: "100%" }} onClick={onCreateNeg}>
          ...
          {activeNeg && (<>
            ...
            <div className="pipeline-bar" style={{ marginBottom: 12 }}>
              {PIPELINE_STAGES.map((stg, i) => {
                const active = stg === activeNeg?.stage, passed = PIPELINE_STAGES.indexOf(activeNeg?.stage) > i;
