...
/* Override CRM global styles for Simulador */
#simulador-root { background: #060A12; color: rgba(255,255,255,.92); font-family: 'DM Sans', sans-serif; font-size: 14px; min-height: 100vh; }
#simulador-root .btn { display:inline-flex;align-items:center;justify-content:center;gap:5px;padding:9px 14px;border-radius:9px;font-size:12px;font-weight:600;cursor:pointer;transition:all .2s;font-family:'DM Sans',sans-serif;border:none;white-space:nowrap;background:rgba(255,255,255,.06);color:rgba(255,255,255,.45); }
...
#simulador-root .btn-gold:hover { transform:translateY(-1px);box-shadow:0 5px 16px rgba(201,168,76,.3); }
...
#simulador-root .btn-dim:hover { background:rgba(255,255,255,.1)!important;color:rgba(255,255,255,.92)!important; }
...
#simulador-root .btn-sm { padding:6px 11px!important;font-size:11px!important;border-radius:7px!important; }
#simulador-root .btn:disabled { opacity:.3!important;cursor:not-allowed!important; }
...
#simulador-root select, #simulador-root .sel { width:100%;background:rgba(255,255,255,.05)!important;border:1px solid rgba(255,255,255,.11)!important;border-radius:9px!important;padding:9px 11px!important;font-size:13px!important;color:rgba(255,255,255,.92)!important;font-family:'DM Sans',sans-serif;outline:none; }
#simulador-root input:not([type=range]):not([type=checkbox]), #simulador-root .inp { width:100%;background:rgba(255,255,255,.05)!important;border:1px solid rgba(255,255,255,.11)!important;border-radius:9px!important;padding:9px 11px!important;font-size:13px!important;color:rgba(255,255,255,.92)!important;font-family:'DM Sans',sans-serif;outline:none; }
#simulador-root textarea { background:rgba(255,255,255,.05)!important;border:1px solid rgba(255,255,255,.11)!important;border-radius:9px!important;padding:9px 11px!important;color:rgba(255,255,255,.92)!important; }
#simulador-root .card-click { cursor:pointer!important;transition:all .2s; }
#simulador-root .card { background:#0F1928;border:1px solid rgba(201,168,76,.18);border-radius:13px;padding:14px; }
#simulador-root .card-sel { border-color:#C9A84C!important;background:rgba(201,168,76,.06)!important; }
` }} />
      {toast && (
        <div style={{
