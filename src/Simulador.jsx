...
function calcSim(g) {
  ...
  return { ps, lv, lvProprio, lvEmbutido, fr, pl, plReduzida, tl, cet, pmtCEF, pmtBco, ttCEF, ttBco, ecCEF, ecBco, cf, inccGanho, inccPct, vv, gvenda, roi, anos, lancePct };
}
  ...
  return (
    <div>
      ...
      <div className="sec-block">
        ...
        <div className="kv"><span className="kv-l">Custo Total</span><span className="kv-r">{R(sim.tl)}</span></div>
        {p.opcoes.cet && !isSimple && <div className="kv"><span className="kv-l">CET Estimado</span><span className="kv-r">{Pt(sim.cet)} a.a.</span></div>}
      </div>
